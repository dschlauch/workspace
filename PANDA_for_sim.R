...
setwd("C:/Users/Dan/Dropbox/Dan's/Documents/Harvard/Research/panda/Version1/YeastData")
...
if (updateMethod=='danmethod'){
  ...
  {
  	Responsibility=cor(TFCoop, RegNet);
  	Availability=cor(t(RegNet), GeneCoReg);
